...
(package! org-bullets :recipe (:fetcher github :repo "sabof/org-bullets"))
(package! toc-org)
...
(when (featurep! +babel)
  ...
  (package! ob-mongo)
  (package! ob-redis
    :recipe (:fetcher github :repo "stardiviner/ob-redis"))
...
(when (featurep! +present)
  (package! centered-window
    :recipe (:fetcher github :repo "anler/centered-window-mode"))
